    ...
    <div className="fp">
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Radison</span>
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Hayatt Regency</span>
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Oberoi Udaivillas</span>
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Leela Palace</span>
